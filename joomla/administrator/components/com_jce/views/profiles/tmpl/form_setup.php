    ...
    <ul class="adminformlist">
        ...
        <li>
			...
			<span style="display:inline-block;">
				...
				<span style="display:block; margin:5px 0 0;">
					<a class="dialog users modal" rel="{'width':760, 'height':540}" title="<?php echo WFText::_('WF_PROFILES_USERS_ADD');?>" href="index.php?option=com_jce&tmpl=component&view=users">
