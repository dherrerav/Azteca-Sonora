<link type="text/stylesheet" rel="stylesheet" href="<?= JURI::base() ?>/modules/mod_tweetticker/stylesheets/styles.css" />
<script type="text/javascript" src="http://code.jquery.com/jquery-latest.pack.js"></script>
<script type="text/javascript" src="<?= JURI::base() ?>/modules/mod_tweetticker/javascripts/jcarousellite_1.0.1.pack.js"></script>
