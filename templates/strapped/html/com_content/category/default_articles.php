...
<form action="<?php echo htmlspecialchars(JFactory::getURI()->toString()); ?>" method="post" name="adminForm" id="adminForm">
	...
	<fieldset class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label" for="filter-search"><?php echo JText::_('COM_CONTENT_'.$this->params->get('filter_field').'_FILTER_LABEL').'&#160;'; ?></label>
			<div class="controls">
	...
	<table class="table table-bordered table-striped">
		...
		<tbody>
			...
			<tr class="cat-list-row<?php echo $i % 2; ?>" >
				...
				<td class="list-title"> <a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid)); ?>"> <?php echo $this->escape($article->title); ?></a>
					<?php if ($article->params->get('access-edit')) : ?>
					<div class="actions btn-group pull-right">
						<span class="btn edit-icon"> <?php echo JHtml::_('icon.edit', $article, $params); ?> </span>
					</div>
					<?php endif; ?>
				</td>
				<?php if ($this->params->get('list_show_date')) : ?>
				<td class="list-date"> <?php echo JHtml::_('date', $article->displayDate, $this->escape(
				...
				<td>
					<?php
						...
						?>
					<a href="<?php echo $fullURL; ?>" class="register"> <?php echo JText::_( 'COM_CONTENT_REGISTER_TO_READ_MORE' ); ?></a> </td>
				<?php endif; ?>
			</tr>
			<?php endforeach; ?>
		</tbody>
