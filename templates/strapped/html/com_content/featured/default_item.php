...
<div class="system-unpublished">
	...
	<p class="article-info">
		...
		<dd class="modified"> <?php echo JText::sprintf('COM_CONTENT_LAST_UPDATED', JHtml::_('date', $this->item->modified, JText::_('DATE_FORMAT_LC1'))); ?> </dd>
		<?php endif; ?>
		<?php if ($params->get('show_publish_date')) : ?>
		<dd class="published"> <?php echo JText::sprintf('COM_CONTENT_PUBLISHED_DATE_ON', JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC1'))); ?> </dd>
		<?php endif; ?>
		-->
...
?>
	<p class="readmore"> <a href="<?php echo $link; ?>" class="btn btn-small btn-primary">
