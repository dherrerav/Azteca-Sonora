...
//JLoader::register('SefExt', JPATH_ROOT.DS.'components'.DS.'com_sef'.DS.'sef.ext.php');
//JLoader::register('JoomSEF', JPATH_ROOT.DS.'components'.DS.'com_sef'.DS.'joomsef.php');

if (SEFTools::JoomFishInstalled()) {
  require_once (JPATH_ROOT.DS.'components'.DS.'com_joomfish'.DS.'helpers'.DS.'defines.php' );
  JLoader::register('JoomFishManager', JPATH_ROOT.DS.'administrator'.DS.'components'.DS.'com_joomfish'.DS.'classes'.DS.'JoomfishManager.class.php');
}
...
class SEFTools
{
  ...
  function normalizeURI(&$uri)
  {
    ...
    if (!is_null($option)) {
      $extfile = JPATH_ROOT.DS.'components'.DS.'com_sef'.DS.'sef_ext'.DS.$option.'.php';
