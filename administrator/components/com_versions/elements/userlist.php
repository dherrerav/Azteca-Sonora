...
if(class_exists('JFormField')){
	...
	class JFormFieldUserlist extends JFormField
	{
		...
		* @since	1.6
		*/
		protected $type = 'Userlist'; //the form field type
		...
		*/
		protected function getInput()
		{
			...
			$sql = 'SELECT id as group_id,title from #__usergroups';
			...
			return JHTML::_('select.genericlist',  $options, $this->name, trim($attr), 'group_id', 'title', $this->value );
