			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  ...
			  <tr>
				...
				<select name="var_fb" size="1" class="inputbox">
					...
					<option value="0.54054"<?php if ($c->var_fb == "0.54054") { ?> selected="selected"<?php } ?>>1.85:1</option>
					<option value="0.41841"<?php if ($c->var_fb == "0.41841") { ?> selected="selected"<?php } ?>>2.39:1</option>
				</select>
				</td>
			  ...
			  <tr>
				...
				<select name="tar_fb" size="1" class="inputbox">
					...
					<option value="0.66666666"<?php if ($c->tar_fb == "0.66666666") { ?> selected="selected"<?php } ?>>3:2</option>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  ...
			  <tr>
				...
				<select name="scroll_as" size="1" class="inputbox">
					<option value="1000"<?php if ($c->scroll_as == "1000") { ?> selected="selected"<?php } ?>>Very Fast</option>
					<option value="3000"<?php if ($c->scroll_as == "3000") { ?> selected="selected"<?php } ?>>Fast</option>
					<option value="5000"<?php if ($c->scroll_as == "5000") { ?> selected="selected"<?php } ?>>Normal</option>
					<option value="7000"<?php if ($c->scroll_as == "7000") { ?> selected="selected"<?php } ?>>Slow</option>
					<option value="9000"<?php if ($c->scroll_as == "9000") { ?> selected="selected"<?php } ?>>Very Slow</option>
				</select>
				</td>
			  ...
			  <tr>
				...
				<select name="scroll_au" size="1" class="inputbox">
					<option value="auto"<?php if ($c->scroll_au == "auto") { ?> selected="selected"<?php } ?>>Yes</option>
					<option value="manual"<?php if ($c->scroll_au == "manual") { ?> selected="selected"<?php } ?>>No</option>
				</select>
				</td>
