 ...
 * @name        videourl.php
 * @location    /components/com_contushdvideosahre/models/videourl.php
 * @package	Joomla 1.6
...
/**
 * Description :   front page uploading video url model page
 */
...
class Modelcontushdvideosharevideourl extends JModel {
    ...
    function showallurl() {
        ...
        if (JRequest::getVar('imageurl', '', 'get', 'string')) {
            $vurl = JRequest::getVar('imageurl', '', 'get', 'string');
            $video = $this->getVideoType($vurl);
