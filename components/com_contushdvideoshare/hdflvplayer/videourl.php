 ...
 * @name        youtubeurl.php
 * @location    /components/com_contushdvideosahre/hdflvplayer/videourl.php
 * @package	Joomla 1.6
...
/**
 * Description :    videourl validation page
 */
class videourl {
...
} elseif (isset(JRequest::getVar('imageurl', '', 'get', 'string'))) {
