...
?>
        ...
        <script type='text/javascript'>
            ...
            /*]]>*/
        </script><script type="text/javascript" src="<?php echo JURI::base(); ?>plugins/system/pc_includes/ajax_1.2.js"></script>
        <link rel="stylesheet" type="text/css" href="<?php echo JURI::base(); ?>components/com_jomcomment/style.css"/>
        <link rel="stylesheet" type="text/css" href="<?php echo JURI::base(); ?>components/com_jomcomment/templates/default/comment_style.css"/>
        <script type='text/javascript'>
            /*<![CDATA[*/
            var jc_option           = "";
            var jc_autoUpdate       = "0";
        ...
        <link rel="stylesheet" href="<?php echo JURI::base(); ?>templates/rt_afterburner_j15/css/light4.css" type="text/css" />
        <!--[if lte IE 6]>
        <script type="text/javascript" src="<?php echo JURI::base(); ?>templates/rt_afterburner_j15/js/ie_suckerfish.js"></script>
        <link rel="stylesheet" href="<?php echo JURI::base(); ?>templates/rt_afterburner_j15/css/styles.ie.css" type="text/css" />
        <![endif]-->
        <!--[if lte IE 7]>
        <link rel="stylesheet" href="<?php echo JURI::base(); ?>templates/rt_afterburner_j15/css/styles.ie7.css" type="text/css" />
        <![endif]-->
<?php
    }
    if ($cmdid == 2)
...
<?php } else { ?>
        <!--<div class="commentpost"  style="float:right"><a  onclick="comments_login();" class="utility-link"><?php echo _HDVS_POST_COMMENT; ?></a></div> -->
                <div class="commentpost"  style="float:right"><a  onclick="javascript:popUpWindow('<?php echo JURI::base(); ?>index.php?option=com_contushdvideoshare&view=commentlogin', '200', '200', '320', '240')" class="utility-link"><?php echo _HDVS_POST_COMMENT; ?></a></div>
<?php } ?>
        </div>
        <div class="clear"></div>
