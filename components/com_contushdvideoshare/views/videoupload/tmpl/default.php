 ...
 * @name        default.php
 * @location    /components/com_contushdvideosahre/views/videoupload/tmpl/default.php
 * @package	Joomla 1.6
 ...
 */
/*
 * Description : video uploading page
 */
    ...
    <div id="clsdetail">
        <div class="lodinpad">
            ...
            <span class="floatright">
                <input type="button"  value="<?php echo _HDVS_BACK_TO_MY_VIDEOS; ?>" class="button cursor_pointer"  onclick="window.open('<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=myvideos'); ?>','_self');" />
            </span>
            <div class="clear"></div>
            ...
            <div class="allform"  >
                <li class="changeli"><div class="form-label floatleft"><label><?php echo _HDVS_VIDEO_TYPE; ?>:</label></div>
                    <div class="radiobtn" ><input type="radio" class="butnmargin" name="filetype" id="filetype2" value="0" <?php if (isset($videoedit->filepath) && $videoedit->filepath == 'Youtube') { echo 'checked="checked"'; } ?> checked ="checked" onclick="filetypeshow(this);" />&nbsp;&nbsp;<?php echo _HDVS_URL; ?></div>
                    <div class="radiobtn" ><input type="radio"  class="butnmargin" name="filetype" id="filetype1" value="1" <?php if (isset($videoedit->filepath) && $videoedit->filepath == 'File') { echo 'checked="checked"'; } ?> onclick="filetypeshow(this);"/>&nbsp;&nbsp;<?php echo _HDVS_UPLOAD; ?></div>
                </li>
            </div>
            <br/>
                            ...
                            <td>
                                <div id="f1-upload-form" >
                                    <form name="normalvideoform" method="post" enctype="multipart/form-data" >
                                        <input type="file" name="myfile" id="myfile" onchange="enableUpload(this.form.name);" />
                                        <input  class="button cursor_pointer" type="button" name="uploadBtn" value="<?php echo _HDVS_UPLOAD_VIDEO; ?>" disabled="disabled" onclick="return addQueue(this.form.name,this.form.myfile.value);" /><span class="star">*</span>
                                        <label id="lbl_normal"><?php if (isset($videoedit->filepath)) { if ($videoedit->filepath == 'File') echo $videoedit->videourl; } ?></label>
                                        <input type="hidden" name="mode" value="video" />
                                    </form>
                                </div>
                                <div id="f1-upload-progress" >
                                    <div class="floatleft"><img id="f1-upload-image" src="components/com_contushdvideoshare/images/empty.gif'" alt="Uploading"  class="clsempty" /> <label class="postroll"  id="f1-upload-filename">PostRoll.flv</label></div>
                                    <div class="floatright"> 
                                        <span id="f1-upload-cancel"> <a class="clscnl" href="javascript:cancelUpload('normalvideoform');" name="submitcancel"><?php echo _HDVS_CANCEL; ?></a> </span>
                                        <label id="f1-upload-status" class="clsupl"><?php echo _HDVS_UPLOADING; ?></label>
                                        <span id="f1-upload-message" class="clsupl_fail"> <b><?php echo _HDVS_UPLOAD_FAILED; ?>:</b> <?php echo _HDVS_USER_CANCELLED_THE_UPLOAD; ?> </span>
                                    </div>
                                </div>
                            </td>
                        </tr>
                         <tr id="ffmpeg_disable_new2" name="ffmpeg_disable_new1">
                             <td class="form-label"><?php echo _HDVS_UPLOAD_HD_VIDEO; ?></td>
                              <td>
                                  <div id="f2-upload-form" >
                                      <form name="hdvideoform" method="post" enctype="multipart/form-data" >
                                          ...
                                          <input  class="button cursor_pointer" type="button" name="uploadBtn" value="<?php echo _HDVS_UPLOAD_VIDEO; ?>" disabled="disabled" onclick="return addQueue(this.form.name,this.form.myfile.value);" />
                                          <label id="lbl_normal"><?php if (isset($videoedit->filepath)) { if ($videoedit->filepath == 'File') echo $videoedit->hdurl; } ?></label>
                                          <input type="hidden" name="mode" value="video" />
                                      </form>
                                  </div>
                                  <div id="f2-upload-progress" >
                                      <div class="floatleft"><img id="f2-upload-image" src="images/empty.gif'" alt="Uploading"  class="clsempty" /> <label class="postroll"  id="f2-upload-filename">PostRoll.flv</label></div>
                                      <div class="floatright"><span id="f2-upload-cancel"> <a class="clscnl" href="javascript:cancelUpload('hdvideoform');" name="submitcancel"><?php echo _HDVS_CANCEL; ?></a> </span>
                                          <label id="f2-upload-status" class="clsupl"><?php echo _HDVS_UPLOADING; ?></label>
                                          <span id="f2-upload-message" class="clsupl_fail"> <b><?php echo _HDVS_UPLOAD_FAILED; ?>:</b> <?php echo _HDVS_USER_CANCELLED_THE_UPLOAD; ?> </span>
                                      </div>
                                  </div>
                              </td>
                         </tr>
<!-- thumb url reading-->
                          <tr id="ffmpeg_disable_new3" name="ffmpeg_disable_new1">
                              <td class="form-label"><?php echo _HDVS_UPLOAD_THUMB_IMAGE; ?></td>
                              <td>
                                  <div id="f3-upload-form" >
                                      <form name="thumbimageform" method="post" enctype="multipart/form-data" >
                                          <input type="file" name="myfile"  onchange="enableUpload(this.form.name);" />
                                          <input class="button cursor_pointer" type="button" name="uploadBtn" value="<?php echo _HDVS_UPLOAD_VIDEO; ?>" disabled="disabled" onclick="return addQueue(this.form.name,this.form.myfile.value);" /><span class="star">*</span>
                                          <label id="lbl_normal"><?php if (isset($videoedit->filepath)) { if ($videoedit->filepath == 'File') echo $videoedit->thumburl; } ?></label>
                                          <input type="hidden" name="mode" value="image" />
                                      </form>
                                  </div>
                                  <div id="f3-upload-progress" >
                                      <div class="floatleft"><img id="f3-upload-image" src="images/empty.gif' " alt="Uploading" class="clsempty" /> <label class="postroll"  id="f3-upload-filename">PostRoll.flv</label></div>
                                      <div class="floatright">
                                          <span id="f3-upload-cancel"> <a class="clscnl" href="javascript:cancelUpload('thumbimageform');" name="submitcancel"><?php echo _HDVS_CANCEL; ?></a> </span>
                              ...
                              <td class="form-label"><?php echo _HDVS_UPLOAD_PREVIEW_IMAGE; ?></td><td>
                                  <div id="f4-upload-form" >
                                      <form name="previewimageform" method="post" enctype="multipart/form-data" >
                                          <input type="file" name="myfile" onchange="enableUpload(this.form.name);" />
                                          <input  class="button cursor_pointer" type="button" name="uploadBtn" value="<?php echo _HDVS_UPLOAD_VIDEO; ?>" disabled="disabled" onclick="return addQueue(this.form.name,this.form.myfile.value);" />
                                          <label id="lbl_normal"><?php if (isset($videoedit->filepath)) { if ($videoedit->filepath == 'File') echo $videoedit->previewurl; } ?></label>
                                          <input type="hidden" name="mode" value="image" />
                                      </form>
                                  </div>
                                  <div id="f4-upload-progress" >
                                      <div class="floatleft"><img id="f4-upload-image" src="/images/empty.gif'" alt="Uploading" class="clsempty" /> <label class="postroll"  id="f4-upload-filename">PostRoll.flv</label></div>
                                      <div class="floatright">
                                          <span id="f4-upload-cancel"> <a class="clscnl" href="javascript:cancelUpload('previewimageform');" name="submitcancel"><?php echo _HDVS_CANCEL; ?></a> </span>
    ...
    ?>
            <form name="upload1111" action="<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=videoupload'); ?>" method="post" enctype="multipart/form-data" <?php echo $javascript ?> >
                <div name="typeurl" id="typeurl">
                    <br/>
                    <div  class="uplcolor" align="center"><?php if (($this->upload)) { echo $this->upload . '<br/><br/>'; } ?> </div>
                    <div class="allform">
                        <ul>
                            <li class="changeli">
                                <div class="form-label floatleft"><label>Url:</label></div>
                                <div class="form-input floatleft"><input type="text" name="Youtubeurl" value="<?php if (isset($videoedit->filepath)) if ($videoedit->filepath == 'Youtube') echo $videoedit->videourl ?>" class="text" size="20" id="Youtubeurl" onchange="bindvideo();"  /><span class="star">*</span>&nbsp;&nbsp </div>
                            </li>
                        </ul>
                    </div>
                    <div class="clear"></div>
                    <div class="allform">
                        <ul>
                            <li class="changeli">
                                ...
                                ?>
                                <div class="form-input floatleft">Image Url<input type="radio" name="imagepath" id="imagepath" value="1" <?php if (isset($imgresult[0])) { echo "checked='checked'"; } ?> onclick="changeimageurltype(this);">&nbsp;&nbsp;&nbsp;&nbsp;Image Upload<input type="radio" name="imagepath" id="imagepath" value="0" <?php if (!isset($imgresult[0])) { echo "checked='checked'"; }?>  onclick="changeimageurltype(this);"> <div class="clear"></div>
                                    <div id="imageurltype"></div>
                                    <?php if (isset($imgresult[0]))
                                        { ?>
                                      <script type="text/javascript">
                                          document.getElementById('imageurltype').innerHTML='<input type="text" name="thumburl" value="<?php if (isset($videoedit->thumburl) )echo $videoedit->thumburl; ?>" class="text" size="20" id="thumburl"/>';
                                      </script>
                                    <?php
                                        }
                                    else {
                                    ?>
                                  <script type="text/javascript">
                                      document.getElementById('imageurltype').innerHTML='<input type="file" name="thumburl" id="thumburl" onchange="fileformate_check(this);"/><lable><?php if (isset($videoedit->thumburl) )echo $videoedit->thumburl; ?></lable>';
                                  </script>
                                    <?php } ?>
                                </div>
                            </li>
                ...
                <div class="allform">
                    <ul>
                        <li class="changeli">
                            ...
                            <div class="form-input floatleft"><input type="text" name="title" value="<?php if (isset($videoedit->title) )echo $videoedit->title; ?>" class="text" size="20" id="title"/><span class="star">*</span></div>
                        </li>
                        <li class="changeli"> <br />
                            <div class="form-label floatleft"><label><?php echo _HDVS_DESCRIPTION; ?> :</label></div>
                            <div class="form-input floatleft"><textarea name="description" style="width:288px;" id="description"><?php if (isset($videoedit->description)) { echo $videoedit->description; } ?></textarea></div>
                        </li>
                        <li class="changeli">
                            <br />
                            <div class="form-label floatleft"><label><?php echo _HDVS_TAGS; ?> :</label></div>
                            <div class="form-input floatleft"><textarea name="tags1" style="width:288px;" id="tags1"><?php if (isset($videoedit->tags)) { echo $videoedit->tags; } ?></textarea></div>
                        </li>
                        <li class="changeli">
                            <br />
                        ...
                        <li class="changeli clearfix"><br/>
                            ...
                            <div class=" floatleft form-inputnew"><input type="text"  readonly name="tagname" value="<?php if (isset($videoedit->category)) { echo $videoedit->category; } ?>" class="text" size="20" id="tagname" /><span class="star">*</span><input type="button" value="<?php echo _HDVS_RESET_CATEGORY; ?>" class="button" onclick="resetcategory();" ></div>
                        </li>
                        <li class="changeli">
                            <div class="form-label floatleft"><label><?php echo _HDVS_TYPE; ?> :</label></div>
                            <div class="radiobtn floatleft" ><input type="radio" class="butnmargin" name="type" value=0  <?php if (isset($videoedit->type) && $videoedit->type == '0') { echo 'checked="checked"'; } ?> checked="checked"  />&nbsp;&nbsp;<?php echo _HDVS_PUBLIC; ?></div>
                            <div class="radiobtn " ><input type="radio" class="butnmargin" name="type" value=1 <?php if (isset($videoedit->type) && $videoedit->type == '1') { echo 'checked="checked"'; } ?>  />&nbsp;&nbsp;<?php echo _HDVS_PRIVATE; ?></div>
                        </li>
                    </ul>
                        <br/><br/>
                            <?php if (JRequest::getVar('type', '', 'get', 'string') == 'edit') { $editbutton = _HDVS_UPDATE; } else { $editbutton = _HDVS_UPLOAD; } ?>
                ...
                <input type="hidden" name="thump" value="<?php if (isset($imgurl) )echo $imgurl; ?>">
                <input type="hidden" name="flv" value="<?php if (JRequest::getVar('url', '', 'post', 'string') )echo JRequest::getVar('url', '', 'post', 'string'); ?>">
                ...
                <input type="hidden" name="previewimageformval" id="previewimageformval" value="<?php if (isset($imgurl) )echo $imgurl; ?>">
                ...
                <input type="hidden" name="usergroupname" id="usergroupname" value="<?php echo $ugp->group_name; ?>">
            </form>
        </div>
    </div>
</div>
...
<script type="text/javascript">
<?php if (isset($videoedit->filepath) && $videoedit->filepath == 'Youtube') { ?>
        filetypeshow("0");
<?php  } elseif (isset($videoedit->filepath) && $videoedit->filepath == 'File') { ?>
        filetypeshow("1");
<?php  } ?>
</script>