...
//For SEO settings
                                $seoOption = $this->recentvideosrowcol[0]->seo_option;
                                if ($seoOption == 1)
                                {
                                    $recentCategoryVal = "category=" . $this->recentvideos[$i]->seo_category;
                                    $recentVideoVal = "video=" . $this->recentvideos[$i]->seotitle;
                                } 
                                else
                                {
                            ...
                            ?>
                                ...
                                <div class="home-thumb">
                                    <div class="home-play-container" >
                                        <span class="play-button-hover">
                                            <div class="movie-entry yt-uix-hovercard">
                                                  ...
                                                  <div class="tooltip">
                                          <a class=" info_hover featured_vidimg" href="<?php echo 'index.php?option=com_contushdvideoshare&view=player&'.$recentCategoryVal.'&'.$recentVideoVal; ?>" ><p class="thumb_resize"><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0"  width="145" height="80" title=""  /></p></a>
                                               
                                                <div class="Tooltipwindow" >
                                               <img src="<?php echo JURI::base();?>components/com_contushdvideoshare/images/tip.png" class="tipimage"/>
                                                    <?php echo '<div class="clearfix"><span class="clstoolleft">' . _HDVS_CATEGORY . ' : ' . '</span>' .'<span class="clstoolright">'. $this->recentvideos[$i]->category.'</span></div>'; ?>
                                                    <?php echo '<span class="clsdescription">' . _HDVS_DESCRIPTION . ' : ' . '</span>' .'<p>'. $this->recentvideos[$i]->description.'</p>'; ?>
                                                                                                      <?php if ($this->recentvideosrowcol[0]->viewedconrtol == 1) { ?>
                                                    <div class="clearfix"><span class="clstoolleft"><?php echo _HDVS_VIEWS; ?>: </span><span class="clstoolright"><?php echo $this->recentvideos[$i]->times_viewed; ?> </span></div>
                                                           <?php } ?></div></div>
                                    ...
                                    <div class="show-title-container">
                                        <a href="<?php echo 'index.php?option=com_contushdvideoshare&view=player&'.$recentCategoryVal.'&'.$recentVideoVal; ?>" class="show-title-gray info_hover">
                                        <?php
                                                        if (strlen($this->recentvideos[$i]->title) > 18)
                                                        {
                                                            echo JHTML::_('string.truncate', ($this->recentvideos[$i]->title), 18);
...
?></a>                                                    </div>
                                    ...
                                    <a href="<?php echo JRoute::_('index.php?option=com_contushdvideoshare&view=category&'.$recentCategoryVal); ?>">
                                    <?php echo $this->recentvideos[$i]->category; ?>
                                    </a>
                                                        </span>
                                    ...
                                    <?php } ?>
                                                        ...
                                                        <?php if ($this->recentvideosrowcol[0]->viewedconrtol == 1) { ?>
                                                                ...
                                                                <span class="floatright viewcolor view"><?php echo $this->recentvideos[$i]->times_viewed; ?></span>
