 ...
 * @name        default.php
 * @location    /components/com_contushdvideosahre/views/relatedvideos/tmpl/default.php
 * @package	Joomla 1.6
 ...
 */
/*
 * Description : related video layout
 */
                                        ...
                                        ?>
                                            <div class="home-thumb">
                                                <div class="home-play-container" >
                                                    <span class="play-button-hover">
                                                        <div class="movie-entry yt-uix-hovercard">
                                                            <a class="tooltip" href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&view=player&id=" . $this->relatedvideos[$i]->id . "&catid=" . $this->relatedvideos[$i]->catid); ?>" class="info_hover"><img class="yt-uix-hovercard-target" src="<?php echo $src_path; ?>"  border="0"  width="145" height="80" title=""  />
                                                ...
                                                <div class="show-title-container">
                                                    <a href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&view=player&id=" . $this->relatedvideos[$i]->id . "&catid=" . $this->relatedvideos[$i]->catid); ?>" class="show-title-gray info_hover"><?php if (strlen($this->relatedvideos[$i]->title) > 18) { echo (substr($this->relatedvideos[$i]->title, 0, 18)) . "..."; } else { echo $this->relatedvideos[$i]->title; } ?></a>                                            </div>
                                                <span class="video-info">
                                                    <?PHP ECHO _HDVS_CATEGORY; ?>: <a href="<?php echo JRoute::_("index.php?option=com_contushdvideoshare&view=category&catid=" . $this->relatedvideos[$i]->catid); ?>"><?php echo $this->relatedvideos[$i]->category; ?></a>
                                                </span>
