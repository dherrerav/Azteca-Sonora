...
<div id="jac-post-new-comment">
	<ul class="form-comment">
		...
		<!-- Expan form-->
			<div class="jac-expand-form clearfix">				
				...
				<?php }else{?>
				<li class="clearfix">							
				<label class="description" id="title1"><?php echo JText::_("COMMENT_AS_A_GUEST_OR");?> <strong><a href="javascript:open_login('<?php echo JText::_("LOGIN_NOW");?>');"><?php echo JText::_("LOGIN");?></a></strong></label>																				
				<?php }?>
				...
				<div class="form-userdata clearfix">
					...
					<span class="jac-form-guest">
						...
						<input id="guestName" value="<?php //echo JText::_("TEXT_NAME");?>" name="name" type="text" class="field text inputbox <?php //jac-inner-text?>" size="18" tabindex="2" title="<?php echo JText::_("DISPLAYED_NEXT_TO_YOUR_COMMENTS");?>"/>
				...
				<li class="clearfix">
					...
					<div id="jac-new-captcha">
						<img alt="Captcha Image" alt="<?php echo JText::_("CLICK_HERE_TO_REFRESH_CAPTCHA");?>" title="<?php echo JText::_("CLICK_TO_REFRESH_CAPTCHA");?>" onmousemove="actionjacLoadNewCaptcha('show')" onmouseout="actionjacLoadNewCaptcha()" onclick="jacLoadNewCaptcha(0)" id="jac_image_captcha"  src="<?php echo JURI::base();?>index.php?option=com_jacomment&amp;task=displaycaptchaaddnew"/>						
					...
					<li class="clearfix">
						<div id="jac-terms" style="clear: both" class="checkbox">																	
							<label class="jac-terms-confirm choice" for="chkTermsAddnew">
								<input type="checkbox" name="chkTermsAddnew" id="chkTermsAddnew"  tabindex="7"/>&nbsp;<?php echo JText::_("I_HAVE_READ_TEXT");?> <a onclick="showWebsiteRules('<?php echo JText::_("WEBSITE_RULES");?>')" href="#" class="jac-link-website-rules" title="<?php echo "Website rules";?>"><?php echo JText::_("WEBSITE_RULES");?></a>
	...
	<div class="jac-addnew clearfix" style="clear:both;">
		...
		<a tabindex="9" href="javascript:postNewComment()" title="<?php echo JText::_("POST_NEW_COMMENT");?>" id="jac_post_new_comment"><?php echo JText::_("SUBMIT_COMMENT");?></a>
		<span id="jac_span_post_new_comment" style="display: none;"><?php echo JText::_("SUBMIT_COMMENT");?></span>-->		
	</div>
	<!--END - action buttion	-->
	</li>
	</ul>
